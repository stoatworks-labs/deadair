...
deadair is built on other people's work. This file lists what that work is, who did
...
An npm dependency, bundled into the page.

Demuxes the recording and muxes the rendered MP4 around the browser's own WebCodecs decoders and encoders, so Dead Air can cut a file in the page without shipping ffmpeg.
